...
def test_db_writeable_check_success():
    ...
    from app.routes.preflight.checks import check_db_writeable
    
    with patch('app.routes.preflight.checks.get_engine') as mock_get_engine:
        mock_engine = MagicMock()
        mock_connection = MagicMock()
        mock_engine.connect.return_value.__enter__.return_value = mock_connection
        mock_get_engine.return_value = mock_engine
        
        writeable, error = check_db_writeable()
...
def test_mcp_routes_mounted_check():
    ...
    from app.routes.preflight.checks import check_mcp_routes_mounted
    ...
    with patch('app.main.app') as mock_app:
        ...
        result = check_mcp_routes_mounted()
...
def test_external_agents_schema_check():
    ...
    from app.routes.preflight.checks import check_external_agents_schema
    ...
    has_agent_type, has_protocol = check_external_agents_schema(mock_session)
