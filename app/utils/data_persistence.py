...
def import_all_data(session: Session, backup_file: Optional[str] = None) -> Dict[str, Any]:
    ...
    import_tenants(session, backup_data.get("tenants", []))
...
def import_tenants(session: Session, tenants_data: List[Dict[str, Any]]) -> None:
    """Import tenants and their products."""
